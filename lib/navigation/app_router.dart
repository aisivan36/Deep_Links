...
class AppRouter extends RouterDelegate<AppLink>
  ...
  AppLink getCurrentPath() {
    ...
    if (!appStateManager.isLoggedIn) {
      ...
      ///return the app link with the onboarding path
    } else if (!appStateManager.isOnboardingComplete) {
  ...
  /// which checks the app state and returns the right app link configuraiton
  @override
  AppLink get currentConfiguration => getCurrentPath();

  @override
  Future<void> setNewRoutePath(AppLink newLink) async {
    /// switch to check every location
...
//If itemId is not null, set the selected grocery item and
//show the Grocery Item screen
